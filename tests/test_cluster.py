...
@pytest.mark.parametrize("sample,starts,expected", [
    (
        [1, 3, 5],
        [0, 1, 2],
        ["1.0000_1.0000_1.0000", "3.0000_3.0000_3.0000", "5.0000_5.0000_5.0000"]
    ),
    (
        [1, 3, 4, 7],
        [0, 1, 3],
        ["1.0000_1.0000_1.0000", "3.5000_3.0000_4.0000", "3.5000_3.0000_4.0000", "7.0000_7.0000_7.0000"]
    ),
    (
        [1, 2, 5, 6],
        [0, 2],
        ["1.5000_1.0000_2.0000", "1.5000_1.0000_2.0000", "5.5000_5.0000_6.0000", "5.5000_5.0000_6.0000"]
